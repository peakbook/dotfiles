...
nnoremap("<leader>lo", "<cmd>Lspsaga outline<CR>", true)
nnoremap("<leader>ln", "<cmd>Lspsaga diagnostic_jump_next<CR>", true)
...
nnoremap("<leader>dl", ":lua require'dap.ext.vscode'.load_launchjs()<CR>", true)
